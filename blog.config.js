...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kerwin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '2023年的我,不一样的我', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kerwin2u.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'kerwin, 博客', // 网站关键词 英文逗号隔开
